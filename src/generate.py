...
<img class="pimg--portrait" src="/img/covers-booth.webp?v=7" alt="ATEX ZeroSpray protective cover installed on a painting robot inside a paint booth" width="1124" height="2000">
</div></section>
...
<img class="pimg--wide" src="/img/tack-cloth.webp?v=7" alt="Tack cloth wiping before paint" width="1600" height="900" loading="lazy">
</div></section>
...
<img class="pimg--wide" src="/img/defect-correction.webp?v=7" alt="Spot repair on painted panel" width="1600" height="900" loading="lazy">
</div></section>
...
<img class="pimg--portrait" src="/img/masking-tape.webp?v=7" alt="Masking tape applied along a freshly painted black car body on the line" width="1500" height="2000" loading="lazy">
</div></section>
...
<img class="pimg--wide" src="/img/dunnage-conveyor.webp?v=7" alt="Protective separators on painted parts" width="1600" height="900" loading="lazy">
</div></section>
...
<img class="pimg--wide" src="/img/aerospace-chemistry.webp?v=7" alt="Worker in full PPE applying coating with a spray gun" width="1600" height="900" loading="lazy">
</div></section>
...
AERO_BODY = product_page(
 ...
 '<figure class="solo wide"><img src="/img/aerospace-chemistry.webp?v=7" alt="Worker in full PPE applying coating with a spray gun" width="1600" height="900"><figcaption>Coating application in full PPE — chemistry handled with discipline.</figcaption></figure>',
...
COVERS_BODY = product_page(
 ...
 '<figure class="solo"><img src="/img/covers-booth.webp?v=7" alt="ATEX ZeroSpray protective cover installed on a painting robot inside a paint booth" width="1124" height="2000"><figcaption>ATEX ZeroSpray on a painting robot — base cover in service.</figcaption></figure>',
...
TAPES_BODY = product_page(
 ...
 '<figure class="solo"><img src="/img/masking-tape.webp?v=7" alt="Masking tape applied along a freshly painted black car body on the line" width="1500" height="2000"><figcaption>Edge masking on a bi-color job — clean line, clean removal.</figcaption></figure>',
...
WIPES_BODY = product_page(
 ...
 'mailto:inbox@system.aero?subject=Sample%20request%20%E2%80%94%20system.aero',
 '<figure class="solo wide"><img src="/img/tack-cloth.webp?v=7" alt="Gloved hand wiping an unpainted bumper with a tack cloth in a paintshop" width="1600" height="900"><figcaption>Tack-off before paint — the last line of defense against inclusions.</figcaption></figure>',
...
POLISH_BODY = product_page(
 ...
 'Book a line trial',
 'mailto:inbox@system.aero?subject=Sample%20request%20%E2%80%94%20system.aero',
 '<figure class="solo wide"><img src="/img/defect-correction.webp?v=7" alt="Spot repair sander on a glossy black painted panel at a finish deck" width="1600" height="900"><figcaption>Spot repair on the finish deck — one pass from defect to gloss.</figcaption></figure>',
...
DUNNAGE_BODY = product_page(
 ...
 'mailto:inbox@system.aero?subject=Sample%20request%20%E2%80%94%20system.aero',
 '<figure class="solo wide"><img src="/img/dunnage-conveyor.webp?v=7" alt="Padded protective separators on painted parts hanging on a conveyor" width="1600" height="900"><figcaption>Separators in service — painted parts protected on the line.</figcaption></figure>',
...
PAGES = [
 dict(slug="/", pl_slug="/pl/", title="System.aero \u2014 Industrial consumables for surface protection and finishing",
      desc="Paintshop supplies for automotive, aerospace and manufacturing: robot covers, tapes, wipes, defect correction, dunnage and aerospace chemistry. Krak\u00f3w, Poland.",
