...
AERO_FAQ = [
 ...
 ("Can you supply military-purpose goods?", 'Yes \u2014 we hold MSWiA concession no. B-074/2025 (WT V, trade without storage). Full document: <a href="/docs/koncesja.pdf">license (PDF)</a>.'),
]
AERO_BODY = product_page(
 'Aerospace chemistry',
 "Name the spec. We'll deliver it on time.",
...
COVERS_BODY = product_page(
 ...
 cta2_url='mailto:inbox@system.aero?subject=Quote%20request%20%E2%80%94%20ATEX%20ZeroSpray',
...
TAPES_BODY = product_page(
 'Masking tapes',
 'Applies easy. Removes clean. Survives 160 °C.',
...
WIPES_BODY = product_page(
 'Industrial wipes',
 'No lint. No silicone. A clean start for every coat.',
...
DUNNAGE_BODY = product_page(
 'Dunnage',
 "One scratch, and it's paint shop again. Not on our watch.",
...
PAGES = [
 ...
 dict(slug="/products/paint-defect-correction/", pl_slug="/pl/produkty/korekta-defektow-lakieru/",
      title="One-step paint defect correction | System.aero",
      ...
      body=POLISH_BODY, ld=[product_ld("One-step paint defect correction system", "Complete spot-repair system for paint defects: silicone-free polishing compound, buffing pads, sanding discs.", "/products/paint-defect-correction/"), faq_ld(POLISH_FAQ)]),
